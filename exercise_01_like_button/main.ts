...
Define this class in a separate module and use it in the main module. Simulate the scenario where the user clicks the like component. Display the total number of likes and whether the button is in the selected or 
...
//like.like()
//like.like()
console.log(`likesCount: ${like.likes}, Liked? ${like.liked}`)
